...
class TensorTuple(Value):
    ...
    def __getitem__(self, index: int):
        return nnwf.ops.tuple_get_item(self, index)
    ...
    def __add__(self, other):
        ...
        return nnwf.ops.make_tuple(*[self[i] + other[i] for i in range(len(self))])
...
class Tensor(Value):
    ...
    def __add__(self, other):
        if isinstance(other, Tensor):
            return nnwf.ops.EWiseAdd()(self, other)
        else:
            return nnwf.ops.AddScalar(other)(self)

    def __mul__(self, other):
        if isinstance(other, Tensor):
            return nnwf.ops.EWiseMul()(self, other)
        else:
            return nnwf.ops.MulScalar(other)(self)

    def __pow__(self, other):
        if isinstance(other, Tensor):
            raise NotImplementedError()
        else:
            return nnwf.ops.PowerScalar(other)(self)

    def __sub__(self, other):
        if isinstance(other, Tensor):
            return nnwf.ops.EWiseAdd()(self, nnwf.ops.Negate()(other))
        else:
            return nnwf.ops.AddScalar(-other)(self)

    def __truediv__(self, other):
        if isinstance(other, Tensor):
            return nnwf.ops.EWiseDiv()(self, other)
        else:
            return nnwf.ops.DivScalar(other)(self)

    def __matmul__(self, other):
        return nnwf.ops.MatMul()(self, other)

    def matmul(self, other):
        return nnwf.ops.MatMul()(self, other)

    def sum(self, axes=None):
        return nnwf.ops.Summation(axes)(self)

    def broadcast_to(self, shape):
        return nnwf.ops.BroadcastTo(shape)(self)

    def reshape(self, shape):
        return nnwf.ops.Reshape(shape)(self)

    def __neg__(self):
        return nnwf.ops.Negate()(self)

    def transpose(self, axes=None):
        return nnwf.ops.Transpose(axes)(self)
